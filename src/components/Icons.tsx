...
export function VegIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        d="M12 7C12 7 8 10 8 14C8 16 10 17 12 17C14 17 16 16 16 14C16 10 12 7 12 7Z"
        fill="currentColor"
      />
      <path
        d="M12 7V10"
...
export function NonVegIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BeverageIcon({ className = '', size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9 11h6v2a6 6 0 0 1-6 6v0a6 6 0 0 1-6-6v-2h6z" />
      <path d="M15 11h4a2 2 0 0 1 2 2v0a4 4 0 0 1-4 4h-2" />
    </svg>
  );
}
